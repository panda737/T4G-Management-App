...
const META: Record<string, CategoryMeta> = {
  'Box Sets': {
    ...
    accent: 'bg-gray-400', border: 'border-gray-400', swatch: 'bg-gray-300', chip: LIGHT_CHIP, chevron: 'text-gray-500',
  },
  'Liners': {
    header: 'bg-red-100 text-red-800',
    accent: 'bg-red-400', border: 'border-red-400', swatch: 'bg-red-200', chip: LIGHT_CHIP, chevron: 'text-red-500',
  },
  'Sharps': {
    header: 'bg-yellow-300 text-yellow-900',
    accent: 'bg-yellow-500', border: 'border-yellow-500', swatch: 'bg-yellow-300', chip: LIGHT_CHIP, chevron: 'text-yellow-700',
  },
  'Anatomical (Specibins)': {
    header: 'bg-red-800 text-white',
    accent: 'bg-red-950', border: 'border-red-950', swatch: 'bg-red-800', chip: DARK_CHIP, chevron: 'text-red-200',
  },
  'Pharmaceutical': {
    header: 'bg-emerald-600 text-white',
    accent: 'bg-emerald-800', border: 'border-emerald-800', swatch: 'bg-emerald-600', chip: DARK_CHIP, chevron: 'text-emerald-100',
  },
  'External Customer Containers': {
    header: 'bg-gray-600 text-white',
    accent: 'bg-gray-800', border: 'border-gray-800', swatch: 'bg-gray-600', chip: DARK_CHIP, chevron: 'text-gray-300',
  },
  'Other': {
    header: 'bg-gray-900 text-white',
    accent: 'bg-black', border: 'border-black', swatch: 'bg-gray-900', chip: DARK_CHIP, chevron: 'text-gray-400',
  },
};

const FALLBACK: CategoryMeta = {
  header: 'bg-slate-100 text-slate-800',
  accent: 'bg-slate-400', border: 'border-slate-400', swatch: 'bg-slate-300', chip: LIGHT_CHIP, chevron: 'text-slate-500',
};
