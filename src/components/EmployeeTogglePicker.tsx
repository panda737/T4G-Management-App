...
*/
export default function EmployeeTogglePicker({ value, onChange, excludeIds, positionFilter, hsRoleFilter }: Props) {
  ...
  const available = excludeIds?.length ? employees.filter(e => !excludeIds.includes(e.id)) : employees;
