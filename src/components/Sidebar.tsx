...
const moduleGroups: ModuleGroup[] = [
  ...
  },
  {
    ...
    items: [
      { path: '/commercial/dashboard', label: 'Dashboard', match: ['/commercial/dashboard'] },
      { path: '/commercial/clients', label: 'Accounts', match: ['/commercial/clients', '/commercial/sites', '/commercial/contacts', '/commercial/activities', '/commercial/users'] },
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/stock/clients', label: 'Clients' },
