/*
  # Seed A-Thermal 2026 Waste Transfers

  ## Summary
  Inserts 44 historical waste transfer records for A-Thermal facility covering
  January through May 2026, sourced from athermal_2026_simple_transfers_with_trf.csv.

  ## Details
  - All records linked to existing treatment_daily_log entries by date
  - transfer_type set to 'Outbound' (transfers out to A-Thermal)
  - Covers waste categories: Anatomical, Clinical Glass, Cytotoxic, Other,
    Pharmaceutical, PVC
  - Quantities in kg, manifest numbers preserved from source data
*/
